...
public class ActualizarDescripcionActividad extends Command {
    private final HotelID hotelID;
    private  final ActividadID actividadID;
    private final Descripcion descripcion;
    public ActualizarDescripcionActividad(HotelID hotelID,ActividadID actividadID, Descripcion descripcion) {
