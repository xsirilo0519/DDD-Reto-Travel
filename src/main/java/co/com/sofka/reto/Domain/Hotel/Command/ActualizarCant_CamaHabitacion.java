...
public class ActualizarCant_CamaHabitacion extends Command {
    private final HotelID hotelID;
    private final HabitacionID habitacionID;
    private final Cant_Cama cant_cama;
    public ActualizarCant_CamaHabitacion(HotelID hotelID,HabitacionID habitacionID, Cant_Cama cant_cama) {
